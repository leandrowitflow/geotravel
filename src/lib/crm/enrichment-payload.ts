...
export function buildCrmEnrichmentPayload(
  ...
  return {
    ...
    cabin_luggage_pieces: data.cabin_luggage_pieces ?? undefined,
    cabin_luggage_notes: data.cabin_luggage_notes ?? undefined,
    checked_luggage_pieces: data.checked_luggage_pieces ?? undefined,
    checked_luggage_notes: data.checked_luggage_notes ?? undefined,
    extras_items: data.extras_items ?? undefined,
    extras_none_confirmed: data.extras_none_confirmed ?? undefined,
    extras_notes: data.extras_notes ?? undefined,
